...
from tensorflow.keras.layers import Dense, Conv1D, Input, GlobalAveragePooling1D
from tensorflow.keras.models import Model
from tensorflow.keras.utils import plot_model

IMAGE_PATH = 'output/fully_conv_control.png'
...
def get_model(embedding_layer, max_sequence_length, nb_labels):
    ...
    model = Model(inputs=sequence_input, outputs=topic_pred, name='fully_conv_control')
