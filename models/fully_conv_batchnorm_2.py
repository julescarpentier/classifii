...
IMAGE_PATH = 'output/fully_conv_batchnorm_2.png'
...
def get_model(embedding_layer, max_sequence_length, nb_labels):
    ...
    x = BatchNormalization()(embedded_sequence)
    ...
    model = Model(inputs=sequence_input, outputs=topic_pred, name='fully_conv_batchnorm_2')
