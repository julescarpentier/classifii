...
from utilities.embedding import get_trainable_embedding_layer
...
embedding_layer = get_trainable_embedding_layer(num_words, MAX_SEQUENCE_LENGTH)
...
plot_acc(history, './output/trainable_embedding_layer_acc.png')

# Plot training & validation loss values
plot_loss(history, './output/trainable_embedding_layer_loss.png')
