...
from utilities.glove import get_embeddings_index
...
# note that setting trainable = False will keep the embeddings fixed
...
plt.savefig('./output/pre_trained_trainable_embedding_layer_acc.png')
plt.show()
...
plt.xlabel('Epoch')
plt.legend(['Train', 'Test'], loc='upper left')
plt.savefig('./output/pre_trained_trainable_embedding_layer_loss.png')
plt.show()
